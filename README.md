...
My task was to complete the project by implementing supporting library functions. It helped me to reinforce and practice the operating systems theory I learnt as part of the CSC2035 module.
